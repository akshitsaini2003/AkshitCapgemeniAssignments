...
public partial class NorthWindContext : DbContext
{
    ...
    public virtual DbSet<Sailor> Sailors { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-GLF3FPU\\SQLEXPRESS;Database=NORTHWND;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Bid).HasName("pk_bid");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CustomPr__3214EC071A333699");
        ...
        modelBuilder.Entity<Sailor>(entity =>
        {
            entity.HasKey(e => e.Sid).HasName("pk_sid");

            entity.ToTable("sailors");
